    ...
    },
    {
      ...
      menuItems: [
        ...
        } :
        {
          ...
          route: "#",
          children: [
            { label: "Sign In", route: "/auth/signin", icon: null },
            { label: "Sign Up", route: "/auth/signup", icon: null },
          ],
        },
      ],
    },
            ...
            {menuGroups.map((group, groupIndex) => (
              <div key={groupIndex}>
                ...
                <ul className="mb-6 flex flex-col gap-1.5">
                  {group?.menuItems?.filter(menuItem => menuItem !== null).map((menuItem, menuIndex) => (
                    <SidebarItem
                      key={menuIndex}
                      item={menuItem}
                      pageName={pageName}
